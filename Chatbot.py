...
# Set layout
st.logo('data/logo-new-ok.png') # logo pada sidebar
st.set_page_config(
...
def check_expiry():
    if 'login_time' in st.session_state and 'expiry_minutes' in st.session_state:
        expiry_duration = timedelta(minutes=st.session_state['expiry_minutes'])
        current_time = datetime.now()
        if current_time - st.session_state['login_time'] > expiry_duration:
